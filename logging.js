...
function sendNetworkLog(
    ...
    state,
    version) {
  var formid = "e/1FAIpQLSccMJEXVtJTZrH9nYlRm0f-MtmTUUr3JhHb9lk-TGll8Gin_w";
  var data = {
    "entry.225278216" : uid,
    "entry.930013433" : time,
    "entry.1965305752" : name,
    "entry.465111447" : target,
    "entry.864355309" : info,
    "entry.204818172" : state,
    "entry.890397543" : version,
  };
  var params = [];
  for (key in data) {
